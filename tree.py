...
def main(boards: list):
    ...
    for board in tqdm(boards):
        strat, actions = load_strat(situation, board, line)
        ...
        def get_result(a: pd.DataFrame):
            ...
            return {convert_action_name(k): v for k, v in result.items()}
        ...
        filename = f"/Users/barrybaker/Documents/blackcard2/blackcard2_back/app/saved2/{'_'.join(list(situation.values()))}_{board}_{line}.obj"
